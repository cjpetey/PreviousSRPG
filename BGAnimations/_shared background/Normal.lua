...
local t = Def.ActorFrame {
	InitCommand=function(self)
		...
		self:visible(not ThemePrefs.Get("RainbowMode") and not string.match(style, "SRPG") and style ~= "Technique")
	end,
	...
	VisualStyleSelectedMessageCommand=function(self)
		...
		if ThemePrefs.Get("RainbowMode") or string.match(style, "SRPG") or style == "Technique" then
